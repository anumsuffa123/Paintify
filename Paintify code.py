...
def settings():
    messagebox.showwarning("Settings","Not Available Right Now")
def about():
    messagebox.showinfo("About","Paintify version 1.0:\n This is a simple paint application created by Zoha Nasir, Syeda Fizza Zehra and Anum Suffa")
def writeText(event):
